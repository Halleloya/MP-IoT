...
const REGISTER2_URL = '/policy_api/register2';
const POLICY_URL = '/policy_api/policy';
const COMMAND_URL = '/policy_api/command';
...
const DELETE2_API = '/policy_api/delete2';
...
const show_prompt = function (text, title) {
    if (title == null) {
        title = 'Result'
    }
